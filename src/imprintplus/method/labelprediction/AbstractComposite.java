...
public abstract class AbstractComposite implements InterfacePredictor{
	...
	/**
	 * This method learns a prediction model from a LongitudinalTable. 
	 * This must be called prior to the calling of the predict() methods.
	 * 
	 * @param _obj
	 */
	...
	/**
	 * Iterates over a Map of the LongitudinalObject and 
	 * get the prediction for each object one by one. The
	 * predicted values are returned as a Map<id, predLabel>.
	 * 
	 * @param _objs
	 * @return
	 */
